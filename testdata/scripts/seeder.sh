...
${CCURL} -s "${GITLAB_URL}/api/v4/groups/${pgroup1_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user1_id}&access_level=30"
...
${CCURL} -s "${GITLAB_URL}/api/v4/groups/${pgroup1_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user3_id}&access_level=50"
success "add ${user3_id} to Group1"
${CCURL} -s "${GITLAB_URL}/api/v4/groups/${pgroup2_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user4_id}&access_level=30"
success "add ${user4_id} to Group2"
${CCURL} -s "${GITLAB_URL}/api/v4/groups/${pgroup2_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user5_id}&access_level=40"
success "add ${user5_id} to Group2"
${CCURL} -s "${GITLAB_URL}/api/v4/groups/${pgroup2_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user6_id}&access_level=50"
...
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project1_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user1_id}&access_level=30"
success "add ${user1_id} to Group1/Project1"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project1_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user2_id}&access_level=40"
success "add ${user2_id} to Group1/Project1"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project1_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user4_id}&access_level=30"
success "add ${user4_id} to Group1/Project1"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project2_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user5_id}&access_level=40"
success "add ${user5_id} to Group1/Project2"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project2_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user7_id}&access_level=40"
success "add ${user7_id} to Group1/Project2"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project2_id}/members" -d "access_token=${GITLAB_PRIVATE_TOKEN}&user_id=${user8_id}&access_level=40"
...
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${project1_id}/hooks" -d "access_token=${GITLAB_PRIVATE_TOKEN}&url=http%3A%2F%2Fwww.sample1.com%2F"
success "hooks in Project1 created"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${project2_id}/hooks" -d "access_token=${GITLAB_PRIVATE_TOKEN}&url=http%3A%2F%2Fwww.sample2.com%2F"
success "hooks in Project2 created"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${project3_id}/hooks" -d "access_token=${GITLAB_PRIVATE_TOKEN}&url=http%3A%2F%2Fwww.sample3.com%2F"
success "hooks in Project3 created"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${project4_id}/hooks" -d "access_token=${GITLAB_PRIVATE_TOKEN}&url=http%3A%2F%2Fwww.sample4.com%2F"
success "hooks in Project4 created"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${project5_id}/hooks" -d "access_token=${GITLAB_PRIVATE_TOKEN}&url=http%3A%2F%2Fwww.sample5.com%2F"
success "hooks in Project5 created"

echo ""
# push some commits in preparation for creation of git tags
info "Push commits for projects"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project1_id}/repository/files/README.md" -d "access_token=${GITLAB_PRIVATE_TOKEN}&branch=master&content=Test&commit_message=First+commit"
success "commit master branch to Group1/Project1"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project2_id}/repository/files/README.md" -d "access_token=${GITLAB_PRIVATE_TOKEN}&branch=master&content=Test&commit_message=First+commit"
success "commit master branch to Group1/Project2"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project3_id}/repository/files/README.md" -d "access_token=${GITLAB_PRIVATE_TOKEN}&branch=master&content=Test&commit_message=First+commit"
success "commit master branch to Group1/Project3"

echo ""
# create tags
info "Creating tags for projects"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project1_id}/repository/tags" -d "access_token=${GITLAB_PRIVATE_TOKEN}&tag_name=sample_1.0&ref=master"
success "Group1/Project1 sample_1.0 master branch tag created"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project2_id}/repository/tags" -d "access_token=${GITLAB_PRIVATE_TOKEN}&tag_name=sample_1.0&ref=master"
success "Group1/Project2 sample_1.0 master branch tag created"
${CCURL} -s "${GITLAB_URL}/api/v4/projects/${group_project3_id}/repository/tags" -d "access_token=${GITLAB_PRIVATE_TOKEN}&tag_name=sample_1.0&ref=master"
